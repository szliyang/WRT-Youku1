...
set network.public='interface'
set network.public.ifname='eth0.3'
set network.public.type='bridge'
set network.public.proto='static'
set network.public.ipaddr='192.168.215.1'
set network.public.netmask='255.255.255.0'
set network.public.ip6assign='60'
EOF
}
